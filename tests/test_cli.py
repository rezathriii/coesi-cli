...
class TestCLICommands:
    ...
    @patch('os.path.exists', return_value=True)
    def test_prod_command_with_ip(self, mock_exists, mock_load_dotenv, mock_update_env,
                                  mock_manager, mock_validate_env, 
                                  mock_check_docker, mock_validate_ip):
        ...
        mock_manager_instance.up.assert_called_once_with("prod", build=True, detach=True)
